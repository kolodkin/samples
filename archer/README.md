...
from cover, and kills drop exploding, lightning, splitting, freezing, and
burning arrow pickups —
...
or pick a slot (click/tap, or keys 1–7) to choose the arrow yourself. Runs
