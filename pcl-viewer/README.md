...
flat/by-height color modes, a live stats overlay, reset-camera, and box/axes
helpers). Frontend dependencies are vendored ES modules loaded via an import map
